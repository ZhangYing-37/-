...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/exitLogin">退出</a></li>
        </ul>
    </div>
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <c:forEach var="course" items="${sessionScope.courseList}">
                            <dd><a href="${pageContext.request.contextPath}/toPaperListUser?co_id=${course.co_id}">${course.co_name}</a></dd>
                        </c:forEach>
                    </dl>
                </li>
            </ul>
    ...
    <div class="layui-body" style="background-color: lightgray">
        ...
        <div style="padding: 15px;">
            <span style="font-size: 30px; margin-left: 30%;">
                ${sessionScope.loginUser.u_userName}，欢迎使用在线考试系统
            </span>
        </div>
    </div>
...
<script src="${pageContext.request.contextPath}/exam/js/public.js"></script>
<script>
    //JavaScript代码区域
