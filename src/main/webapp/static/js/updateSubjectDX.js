...
layui.use('form', function(){
    var form = layui.form
    form.on('submit(formDX)', function (data) {
...
function addTR(i,j) {
    ...
    for (var k=j;k>i;k--){
        ...
        $tr0.find("#isTrue"+k).attr("name","isTrue"+index);
    ...
    $tr.next().find("#isTrue"+i).attr("name","isTrue"+nextIndex);
...
function removeTR(i,j) {
    if(j>2){
        ...
        for (var l=i+1;l<=j;l++){
            ...
            $tr0.find("#isTrue"+l).attr("name","isTrue"+index);
...
function optionUp(i,j) {
    ...
    if (i!=1){
        ...
        $tr.find("#isTrue"+i).attr("name","isTrue"+index);
        ...
        $tr.next().find("#isTrue"+index).attr("name","isTrue"+i);
...
function optionDown(i,j) {
    ...
    if (i!=j){
        ...
        $tr.prev().find("#isTrue"+index).attr("name","isTrue"+i);
